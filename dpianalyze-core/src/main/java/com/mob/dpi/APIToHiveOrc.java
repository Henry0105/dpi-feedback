...
public class APIToHiveOrc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 必须按顺序排列
        String schema = "gw_id:String,company_name:String,visit_date:String,pv_sum:Int,month_pv_sum:Int,company_address:String";
        ...
        List<ComparableList> rows = HttpUtils.getApiData(date,schema);
